...
def _get_file_name_net_base(
    ...
    if patched and patched_from_af:
        af_name_from = _format_net_af(patched_from_af, patched_from_af_cnn)
        patched_str += f"from_{af_name_from}_"
...
def get_file_name_net(
    ...
    return _get_file_name_net_base(
        ...
        patched_from_af, patched_from_af_cnn
    )
